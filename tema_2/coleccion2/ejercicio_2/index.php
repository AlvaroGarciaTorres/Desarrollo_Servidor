...
END;
    ...
    function printSearch($students_array){
        echo "<div>";           
            if(!searchArray($_GET['student_id'], $students_array)){
                echo "<span>Expediente no encontrado</span>";
            }else{
                echo "<span>Nombre del estudiante: </span><br><br>";
                echo searchArray($_GET['student_id'], $students_array);
            }         
            echo "<br>";
            echo "<br>";
            echo "<button class='btn'><a href='.'>Volver</a></button>";
    ...
    function searchArray($str, $students_array){   
        if(isset($students_array[$str])){
            return $students_array[$str];
        } else return false;
    }
